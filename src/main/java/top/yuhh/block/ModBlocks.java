...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> GRAPHITE = registerBlock("graphite_block", () -> new Block(BlockBehaviour.Properties.of().requiresCorrectToolForDrops().strength(4.5F,4F)));

    public static final DeferredBlock<Block> LACED_GRAPHITE = registerBlock("laced_graphite", () -> new LacedGraphiteBlock(BlockBehaviour.Properties.of().randomTicks().requiresCorrectToolForDrops().strength(4.5F,4F)));

    public static final DeferredBlock<Block> RICH_GRAPHITE = registerBlock("rich_graphite", () -> new RichGraphiteBlock(BlockBehaviour.Properties.of().randomTicks().requiresCorrectToolForDrops().strength(3.5F,3F)));
