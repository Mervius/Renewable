...
@Mod(value = Renewables.MOD_ID, dist = Dist.CLIENT)
...
//    }
    ...
    static void onClientSetup(FMLClientSetupEvent event) {
        ...
        Renewables.LOGGER.info("HELLO FROM CLIENT SETUP");
        Renewables.LOGGER.info("MINECRAFT NAME >> {}", Minecraft.getInstance().getUser().getName());
    }
}
